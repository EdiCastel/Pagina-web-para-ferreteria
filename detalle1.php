...
<nav class="navB">
    ...
    <div style="width:100%;display:flex;flex-direction:row;">
        <div style="width:50%;height:100%;display:flex;">
            <img style="width:100%;height:600px;margin-left:20px;margin-top:40px;border:solid;border-color:black;border-width:20px;" src="imagenes/resistol.jpg"/>
        </div>
        <div style="width:50%;height:500px;display:flex;background-color:#120755;flex-direction:column; color:white;align-items:center;margin-top: 40px;">
            <form style="margin-top:20px;"action="#" method="post">
                ...
                <h6>CÓDIGO PROVEEDOR: 1857126</h6><br>
                <h5>DE: $2,111.00 MXN</h5>
                <h5>A: $2,049.00 MXN IVA INCLUIDO</h5><br><br>                  
